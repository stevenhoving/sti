...
static
void print_x8(__m128i value, const char *section)
{
    ...
    printf("%02X %02X %02X %02X "
        ...
        "%02X %02X %02X %02X "
        "%02X %02X %02X %02X\n\n",
        u8[15], u8[14], u8[13], u8[12],
        u8[11], u8[10], u8[9], u8[8],
        u8[7], u8[6], u8[5], u8[6],
        u8[3], u8[2], u8[1], u8[0]
    );
}
...
static
void print_x16(__m128i value, const char *section)
{
    auto u16 = value.m128i_u16;
    printf("%s\n", section);
    printf("%04X %04X %04X %04X "
        "%04X %04X %04X %04X\n\n",
        u16[7], u16[6], u16[5], u16[6],
        u16[3], u16[2], u16[1], u16[0]
    );
}

static
void print_x32(__m128i value, const char *section)
{
...
static
void print_x64(__m128i value, const char *section)
{
