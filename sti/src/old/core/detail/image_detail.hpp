...
/* handle float/double */
template <typename T>
constexpr T pixel_default_value()
{
...
template <>
constexpr uint8_t pixel_default_value<uint8_t>()
{
    return 255;
}
...
template <>
constexpr uint16_t pixel_default_value<uint16_t>()
{
    return 65535;
}
...
template <>
constexpr uint32_t pixel_default_value<uint32_t>()
{
    return 4294967295;
}
...
/* pixel value limits */
template <typename T>
constexpr T pixel_min_value()
{
    return static_cast<T>(0.0);
}

template <>
constexpr uint8_t pixel_min_value<uint8_t>()
{
    return 0;
}

template <typename T>
constexpr T pixel_max_value()
{
    return static_cast<T>(1.0);
}

template <>
constexpr uint8_t pixel_max_value<uint8_t>()
{
    return 0xFF;
}
